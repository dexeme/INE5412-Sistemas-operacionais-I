...
bool execute() {
    ...
    if (!is_ready_queue_empty()) {
        ...
        int prioridade_processo_atual = fila_de_executando.front().getCreationTime();
        int prioridade_proximo_processo = proximo_processo.getCreationTime();
        ...
        if (prioridade_proximo_processo < prioridade_processo_atual) {
            ...
            switch_process(fila_de_executando.front(), proximo_processo);
        }
